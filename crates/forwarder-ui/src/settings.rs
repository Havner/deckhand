...
impl Default for Settings {
    fn default() -> Self {
        Settings {
            ...
            // Large by default: the 2x UI scale halves the logical space, and the Deck's own display
            // is 1280x800 - so open near full-screen so the scaled content fits without scrolling.
            window_width: 1280,
            window_height: 800,
