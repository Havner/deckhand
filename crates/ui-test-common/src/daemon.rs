//! A thin, blocking client over `ipc` for the top/bottom bars — the toolkit-independent half of
//! the daemon wiring.
//!
...
//!   updates through a callback and reconnecting forever. Each toolkit runs it on a thread and
//!   bridges the callback into its own event pump.
